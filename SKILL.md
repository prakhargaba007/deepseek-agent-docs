...
### Current Models (as of 2026.07.25)
- `deepseek-v4-pro` — 1M context, 384K max output, complex reasoning & agent tasks
- `deepseek-v4-flash` — 1M context, 384K max output, fast & cost-effective

> **Note**: `deepseek-chat` and `deepseek-reasoner` are deprecated as of 2026-07-24.

### Thinking Mode
- Default: **enabled** for both models
- Disable: `{"thinking": {"type": "disabled"}}`
- Effort levels: `"high"` (default) or `"max"` (agent/complex tasks)
